...
$command = "python faceFiles/test.py $refrenceNumber ";
...
$type = $_POST['hi'];
$sql = "INSERT INTO demo.enrollment ('User_Enterprise_id', 'Phone_number', 'Email', 'First_name', 'Last_name', 'RFID_tag_id', 'ImageReference', 'type')
 VALUES ('$userID', '$phoneNumber', '$email', '$firstName', '$lastName', '$RFID_ID', '$imageRefrenceNumber', '$type');"; 
 //mysqli_query($conn, $sql);
 //header("Location: ../enrollment.php?Submit=success");
